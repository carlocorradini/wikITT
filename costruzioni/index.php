...
<html lang="it">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <button class="ui brown labeled icon button" id="btnShowVideoNavigation">
                ...
                <?php
                    ...
                    if(!isset($vID) || $vID === "" || mysqli_num_rows($videoInfo) == 0) {?>
                        ...
                        <div class="ui small breadcrumb" id="breadcrumInfo">
                            ...
                            <div class="active section">Costruzioni</div>
                        </div>
            ...
            <div id="video-navigation">
                <div class="scrollbar costruzioni ui vertical menu">
                    <div class="item">
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($videos) > 0) {
                            while ($row = mysqli_fetch_array($videos)) {
                                if($row["VideoID"] === $vID) { ?>
                                    <a class="font costruzioni active item" href="index.php?v=<?php echo $row["VideoID"];?>" style="font-weight: bold;">
                                        <i class="fire icon"></i>
                                        <?php echo $row["Titolo"];?>
                                    </a>
                                <?php } else {?>
