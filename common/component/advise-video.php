...
<?php
    ...
    if(mysqli_num_rows($risRand) > 0){
            ...
            ?>
            <div class="column">
                <div style="margin:auto" class="ui card <?php echo $color?>" style="cursor: pointer;" onclick="window.location='http://localhost/informatica/index.php?v=<?php echo $row['VideoID'];?>';">
                    <a class="image">
